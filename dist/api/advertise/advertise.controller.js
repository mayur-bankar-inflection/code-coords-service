...
const advertise_validator_1 = require("./advertise.validator");
const advertise_service_1 = require("../../database/services/advertise.service");
const joi_1 = __importDefault(require("joi"));
class AdvertiseController {
    constructor() {
        //#region member variables and constructors
        this._service = new advertise_service_1.AdvertiseService();
        this._validator = new advertise_validator_1.AdvertiseValidator();
        //#endregion
        this.getAll = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const record = yield this._service.allAdvertisers();
                if (record === null) {
                    error_handler_1.ErrorHandler.throwInternalServerError("Unable to Loadvertise all sections!", console_1.error);
                }
...
//# sourceMappingURL=advertise.controller.js.map