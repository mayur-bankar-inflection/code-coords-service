...
const roles_service_1 = require("../../database/services/roles.service");
const joi_1 = __importDefault(require("joi"));
class RolesController {
    constructor() {
        //#region member variables and constructors
        this._service = new roles_service_1.RolesService();
        this._validator = new roles_validator_1.RolesValidator();
        //#endregion
        this.getAll = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const record = yield this._service.allRoles();
                if (record === null) {
                    error_handler_1.ErrorHandler.throwInternalServerError("Unable to Load all Roles!", console_1.error);
                }
        ...
        this.create = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (record === null) {
                    error_handler_1.ErrorHandler.throwInternalServerError("Unable to add Roles !", console_1.error);
                }
