...
const blog_service_1 = require("../../database/services/blog.service");
const joi_1 = __importDefault(require("joi"));
class BlogController {
    constructor() {
        //#region member variables and constructors
        this._service = new blog_service_1.BlogService();
        this._validator = new blog_validator_1.BlogValidator();
        //#endregion
        this.getAll = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const record = yield this._service.allBlogs();
                if (record === null) {
                    error_handler_1.ErrorHandler.throwInternalServerError("Unable to Load all blogs!", console_1.error);
                }
