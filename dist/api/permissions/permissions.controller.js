...
const permissions_validator_1 = require("./permissions.validator");
const permissions_service_1 = require("../../database/services/permissions.service");
const joi_1 = __importDefault(require("joi"));
class PermissionsController {
    constructor() {
        //#region member variables and constructors
        this._service = new permissions_service_1.PermissionsService();
        this._validator = new permissions_validator_1.PermissionsValidator();
        //#endregion
        this.getAll = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const record = yield this._service.allPermissions();
                if (record === null) {
                    error_handler_1.ErrorHandler.throwInternalServerError("Unable to Load all Permissions!", console_1.error);
                }
                const message = "All Permissions retrived successfully!";
        ...
        this.create = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (record === null) {
                    error_handler_1.ErrorHandler.throwInternalServerError("Unable to add Permissions !", console_1.error);
                }
                const message = "Permissions added successfully!";
                return response_handler_1.ResponseHandler.success(request, response, message, 201, record);
            }
            catch (error) {
                response_handler_1.ResponseHandler.handleError(request, response, error);
