...
const signup_service_1 = require("../../database/services/signup.service");
const joi_1 = __importDefault(require("joi"));
class SignUpController {
    constructor() {
        //#region member variables and constructors
        this._service = new signup_service_1.SignUpService();
        this._validator = new signup_validator_1.SignUpValidator();
        //#endregion
        this.getAll = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const record = yield this._service.allSignUp();
                if (record === null) {
                    error_handler_1.ErrorHandler.throwInternalServerError("Unable to load signup all sections!", console_1.error);
                }
