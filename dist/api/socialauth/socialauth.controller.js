...
const socialauth_validator_1 = require("./socialauth.validator");
const socialauth_service_1 = require("../../database/services/socialauth.service");
const joi_1 = __importDefault(require("joi"));
class SocialAuthController {
    constructor() {
        //#region member variables and constructors
        this._service = new socialauth_service_1.SocialAuthService();
        this._validator = new socialauth_validator_1.SocialAuthValidator();
        //#endregion
        this.getAll = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const record = yield this._service.allSocialAuth();
                if (record === null) {
                    error_handler_1.ErrorHandler.throwInternalServerError("Unable to Load all SocialAuth!", console_1.error);
                }
        ...
        this.create = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (record === null) {
                    error_handler_1.ErrorHandler.throwInternalServerError("Unable to add SocialAuth !", console_1.error);
                }
