...
const reviews_service_1 = require("../../database/services/reviews.service");
const joi_1 = __importDefault(require("joi"));
class ReviewsController {
    constructor() {
        //#region member variables and constructors
        this._service = new reviews_service_1.ReviewsService();
        this._validator = new reviews_validator_1.ReviewsValidator();
        //#endregion
        this.getAll = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const record = yield this._service.allReviews();
                if (record === null) {
                    error_handler_1.ErrorHandler.throwInternalServerError("Unable to Load reviews all sections!", console_1.error);
                }
