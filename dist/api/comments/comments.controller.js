...
const comments_validator_1 = require("./comments.validator");
const comments_service_1 = require("../../database/services/comments.service");
const joi_1 = __importDefault(require("joi"));
class CommentsController {
    constructor() {
        //#region member variables and constructors
        this._service = new comments_service_1.CommentsService();
        this._validator = new comments_validator_1.CommentsValidator();
        //#endregion
        this.getAll = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const record = yield this._service.allCommentss();
                if (record === null) {
                    error_handler_1.ErrorHandler.throwInternalServerError("Unable to LoComments all sections!", console_1.error);
                }
