...
exports.RolePermissionsValidator = void 0;
        ...
        this.validateCreateRequest = (request) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const schema = joi_1.default.object({
                    ...
                    PermissionsId: joi_1.default.string().optional(),
                });
                yield schema.validateAsync(request.body);
                return {
                    UserId: (_a = request.body.UserId) !== null && _a !== void 0 ? _a : null,
                    RoleId: (_b = request.body.RoleId) !== null && _b !== void 0 ? _b : null,
                    PermissionId: (_c = request.body.PermissionId) !== null && _c !== void 0 ? _c : null,
                };
            }
            catch (error) {
...
exports.RolePermissionsValidator = RolePermissionsValidator;
//# sourceMappingURL=rolepermissions.validator.js.map