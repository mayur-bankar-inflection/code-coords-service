...
const rolepermissions_validator_1 = require("./rolepermissions.validator");
const rolepermissions_service_1 = require("../../database/services/rolepermissions.service");
const joi_1 = __importDefault(require("joi"));
class RolePermissionsController {
    constructor() {
        //#region member variables and constructors
        this._service = new rolepermissions_service_1.RolePermissionsService();
        this._validator = new rolepermissions_validator_1.RolePermissionsValidator();
        //#endregion
        this.getAll = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const record = yield this._service.allRolePermissions();
                if (record === null) {
                    error_handler_1.ErrorHandler.throwInternalServerError("Unable to Load all RolePermissions!", console_1.error);
                }
        ...
        this.create = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (record === null) {
                    error_handler_1.ErrorHandler.throwInternalServerError("Unable to add RolePermissions !", console_1.error);
                }
