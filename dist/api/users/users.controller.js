...
class UsersController {
    constructor() {
        ...
        this._service = new users_service_1.UsersService();
        this._validator = new users_validator_1.UsersValidator();
        //#endregion
        this.getAll = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const record = yield this._service.allUsers();
                if (record === null) {
                    error_handler_1.ErrorHandler.throwInternalServerError("Unable to Load all Users!", console_1.error);
                }
        ...
        this.create = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (record === null) {
                    error_handler_1.ErrorHandler.throwInternalServerError("Unable to add Users !", console_1.error);
                }
