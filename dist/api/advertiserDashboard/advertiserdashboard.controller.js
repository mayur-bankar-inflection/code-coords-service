...
exports.AdvertiserDaashboardController = void 0;
const response_handler_1 = require("../../common/response.handler");
const error_handler_1 = require("../../common/error.handler");
const console_1 = require("console");
const advertiserdashboard_validator_1 = require("./advertiserdashboard.validator");
const advertiserdashboard_service_1 = require("../../database/services/advertiserdashboard.service");
const joi_1 = __importDefault(require("joi"));
class AdvertiserDaashboardController {
    constructor() {
        //#region member variables and constructors
        this._service = new advertiserdashboard_service_1.AdvertiserDashboardService();
        this._validator = new advertiserdashboard_validator_1.AdvertiserDashboardValidator();
        //#endregion
        this.getAll = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                const record = yield this._service.allAdvertiserDashboard();
                if (record === null) {
                    error_handler_1.ErrorHandler.throwInternalServerError("Unable to Load all AdvertiserDaashboard!", console_1.error);
                }
        ...
        this.create = (request, response) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (record === null) {
                    error_handler_1.ErrorHandler.throwInternalServerError("Unable to add AdvertiserDaashboard !", console_1.error);
                }
...
exports.AdvertiserDaashboardController = AdvertiserDaashboardController;
//# sourceMappingURL=advertiserdashboard.controller.js.map