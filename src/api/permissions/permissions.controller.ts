...
import { PermissionsService } from "../../database/services/permissions.service";
import {
...
export class PermissionsController {
  ...
  _service: PermissionsService = new PermissionsService();

  _validator: PermissionsValidator = new PermissionsValidator();
  ...
  getAll = async (request: express.Request, response: express.Response) => {
    try {
      const record = await this._service.allPermissions();
      if (record === null) {
        ErrorHandler.throwInternalServerError(
          "Unable to Load all Permissions!",
          error
        );
      }
  ...
  create = async (request: express.Request, response: express.Response) => {
    try {
      const model: PermissionsCreateModel =
  ...
  update = async (request: express.Request, response: express.Response) => {
    try {
      ...
      var model: PermissionsUpdateModel = await this._validator.validateUpdateRequest(
        request
      );
